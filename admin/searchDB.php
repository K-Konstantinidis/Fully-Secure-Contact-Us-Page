...
<html lang="en">
	...
	<body>
		<?php
			...
			$searchFirstName = test_input($_POST['search1']);
			$searchGrind = test_input($_POST['search2']);
			$searchDrink = test_input($_POST['search3']);

			//Select from records
			$sql = "SELECT * FROM records WHERE First_Name LIKE '%$searchFirstName%' AND Grind LIKE '%$searchGrind%' AND Drink LIKE '%$searchDrink%'";
